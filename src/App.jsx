        ...
        <div className="todos flex flex-col gap-1">
          ...
          {displayedTodos.map((item) => (
            ...
            >
              <div className="flex items-center gap-5 font-semibold text-xl">
                ...
                {editingId === item.id ? (
                  ...
                  <span
                    ...
                    } overflow-hidden text-ellipsis line-clamp-1 max-md:text-sm max-md:max-w-[75%] absolute  top-4 sm:left-14 left-11 font-[650]`}
                  >
                    {item.text}
                  </span>
                )}
              ...
              <div className="text-gray-500 text-[13px] font-bold absolute  bottom-1 sm:left-14 left-11  w-[200px]">
                {item.date}
              </div>
            </div>
          ))}
